...
console.log(parseFloat('  32434.343')); // Mesma função sem o Number
console.log(Number.parseFloat('100.27 reais')); // 99.5
...
Math.abs(-5.5); // 5.5
Math.ceil(4.8334); // 5 -- força arredondar o numero para cima
Math.ceil(4.3); // 5 -- mesmo do ex acima
Math.floor(4.8334); // 4 -- força arredondar o numero para baixo
Math.floor(4.3); // 4 -- mesmo exemplo acima
Math.round(4.8334); // 5 -- arrendonda automaticamente para cima ou para baixo, se o num for .5 ou maior, arredonda para cima, caso contrario, para baixo
Math.round(4.3); // 4
